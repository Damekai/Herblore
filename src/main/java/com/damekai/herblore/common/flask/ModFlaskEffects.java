...
public class ModFlaskEffects
{
    ...
    public static final RegistryObject<FlaskEffect> DREDGE = FLASK_EFFECTS.register("dredge", () -> new FlaskEffectDredge(new FlaskEffect.Properties().translationName("dredge").baseDuration(1800).color(0x6B4A46).guiEffect(ModEffects.DREDGE_RENDER), 20));
