...
public class ModFlasks
{
    ...
    public static final RegistryObject<Flask> DEBUG_AB = FLASKS.register("debug_ab", () -> new Flask("debug_ab",
            ModFlaskEffects.DEBUG_ALPHA,
            ModFlaskEffects.DEBUG_BETA));

    public static final RegistryObject<Flask> DEBUG_CDE = FLASKS.register("debug_cde", () -> new Flask("debug_cde",
            ModFlaskEffects.DEBUG_GAMMA,
            ModFlaskEffects.DEBUG_DELTA,
            ModFlaskEffects.DEBUG_EPSILON));

    public static final RegistryObject<Flask> DEBUG_BONANZA = FLASKS.register("debug_bonanza", () -> new Flask("debug_bonanza",
                    ModFlaskEffects.DEBUG_ALPHA,
                    ModFlaskEffects.DEBUG_BETA,
                    ModFlaskEffects.DEBUG_GAMMA,
                    ModFlaskEffects.DEBUG_DELTA,
