...
public class ModBlocks
{
    ...
    public static final RegistryObject<BlockPerennialCrop> SUNSTRIDERS_SIN_CROP = BLOCKS.register("sunstriders_sin_crop", () -> new BlockPerennialCrop(ModItems.SUNSTRIDERS_SIN.getSeeds()));
