...
public class ModHerbloreEffects
{
    ...
    public static final RegistryObject<HerbloreEffect> SHADOWSTEP = HERBLORE_EFFECTS.register("shadowstep", () -> new HerbloreEffectShadowstep(ModEffects.SHADOWSTEP_RENDER));
    public static final RegistryObject<HerbloreEffect> GLACIAL = HERBLORE_EFFECTS.register("glacial", () -> new HerbloreEffectGlacial(ModEffects.GLACIAL_RENDER));
}
