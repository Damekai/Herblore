...
public class ModFlaskEffects
{
    ...
    public static final RegistryObject<FlaskEffect> HOUR_POWER_NOON = FLASK_EFFECTS.register("hour_power_noon", () -> new FlaskEffectHourPower("hour_power_noon", 6000, UUID.fromString("d6baf902-b953-447f-bcaa-d9618c7474e8")));
    public static final RegistryObject<FlaskEffect> HOUR_POWER_MIDNIGHT = FLASK_EFFECTS.register("hour_power_midnight", () -> new FlaskEffectHourPower("hour_power_midnight", 18000, UUID.fromString("b7bff02f-54f4-4589-8917-956c669e376a")));
